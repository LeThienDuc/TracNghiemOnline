	...
	<div class="col-md-12">
		...
		<nav class="col-sm-3 col-md-2 col-2" id="myScrollspy">
			<ul class="nav nav-pills flex-column">
				<li class="nav-item"><a class="nav-link" href="QuanLiCauHoi.jsp" style="color: #0d0003; font-size:18.5px;">Quản lí câu hỏi</a></li>
				<br>
				<li class="nav-item"><a class="nav-link" href="TrangCaNhan_QLCH.jsp" style="color: #0d0003; font-size:18.5px;">Trang cá nhân</a></li>
				<br>
				<li class="nav-item"><a class="nav-link" href="#" style="color: #0d0003; font-size:18.5px;">Đăng Xuất</a></li>
			</ul>
			</nav>
			<div class="col-sm-9 col-md-10 col-10" >
					<div class="col-md-8"><%ServletContext context = getServletContext();%>
