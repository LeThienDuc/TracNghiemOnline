	...
	<%ServletContext context = getServletContext();%>
		<nav class="col-sm-3 col-md-2 col-2" id="myScrollspy">
			<ul class="nav nav-pills flex-column">
				<li class="nav-item"><a class="nav-link" href="ControlerChuyenGV?UserID=<%=context.getAttribute("UserID") %>" style="color: #0d0003; font-size:18.5px;">Quản lí kì thi</a></li>
				<br>
				<li class="nav-item"><a class="nav-link" href="#p" style="color: #0d0003; font-size:18.5px;">Trang cá nhân</a></li>
				<br>
